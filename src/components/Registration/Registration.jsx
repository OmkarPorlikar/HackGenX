...
const Registration = () => {
  ...
  //     // Use the message from backend if available, otherwise use a default message
              ...
              <div>
                ...
                >
                  ...
                  <option value="Smart Warehouse Space Optimization">
                    Smart Warehouse Space Optimization
                  </option>
